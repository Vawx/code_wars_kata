...
describe Book do
  ...
  describe 'title' do
    ...
    # my additional test case of a "book with a really long title", as Google says
    describe 'really long title...' do
      it 'should match the real title' do
        @book.title = "the guernsey literary and potato peel pie society"
        @book.title.should == "The Guernsey Literary and Potato Peel Pie Society"
      end
    end
  end
end
